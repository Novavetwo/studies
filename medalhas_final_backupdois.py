...
def main():
    ...
    # DIDIT: computar e exibir o quadro de medalhas
    # DIDIT: computar e exibir os países que tiverem apenas
...
# 8º - Fazer a formatação das linhas - FEITO
# 9º - Achar uma solução para manejar grandes listas. - 
...
#def formata_linha(medalhas: list[str]) -> str:
#    '''
#    Calcula o espaçamento de cada linha do quadro de medalhas para que as colunas estejam
#    alinhadas e padronizadas.
#    O espaçamento total disponível é de 6 para cada uma das 4 categorias, além de 2 unidades
#    entre cada uma delas.
#    Exemplo:
#    >>> formata_linha(['45', '2', '98', '145'])
#    '45      2       98      145     '
#    '''
#    linha = ''
#    for i in range(3):
#        medalha = medalhas[i]
#        linha = linha + medalha + (' ' * (8 - len(medalha)))
#    return linha
