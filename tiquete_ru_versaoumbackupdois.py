...
def grafico(vendas: list[Registro], vendas_por_pagamento: Soma_Pagamento, receita: int) -> str:
    '''
...
def monta_somas_usuario(vendas: list[Registro]) -> Soma_Usuario:
    '''
    ...
    soma_tiquetes_por_usuario: Soma_Usuario = Soma_Usuario(aluno_soma, servidor_menos_que_tres_soma, \
                                                           servidor_mais_que_tres_soma, docente_soma, externo_soma)
    return soma_tiquetes_por_usuario

def monta_somas_pagamento(vendas: list[Registro]) -> Soma_Pagamento:
    '''
    ...
    soma_pagamento: Soma_Pagamento = Soma_Pagamento(dinheiro_soma, pix_soma, cartao_soma)
